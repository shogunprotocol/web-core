...
const TransactionModal = ({ isOpen, onClose, type = 'deposit' }) => {
          ...
          <ModalBody className="flex flex-col items-center justify-center py-8">
            ...
            <div className="space-y-4 w-full">
              <p className="text-gray-400 text-center text-sm">
                Join the future of DeFi. Access AI-powered yield optimization
                and start earning smarter returns.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-400">
                      ...
                      Our AI automatically manages your position across multiple
                      strategies for optimal yields.
                    </p>
                  </div>
                </div>
              </div>
  ...
  return (
    <Modal
      ...
      classNames={{
        backdrop:
          'bg-gradient-to-t from-zinc-900 to-zinc-900/25 backdrop-opacity-20',
      }}
    >
      <ModalContent className="bg-black-tr">
        <button
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <Tooltip content="Your current share of the vault's total assets">
              <div className="p-4 rounded-xl bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-white/10 cursor-help transition-all duration-200 hover:border-basement-cyan/50">
                ...
                <p className="text-xl font-bold text-basement-cyan">
                  {userBalance ? formatUnits(userBalance, 18) : '0'} shares
                </p>
              </div>
            </Tooltip>
            ...
            <Tooltip content="Total value locked in the vault">
              <div className="p-4 rounded-xl bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-white/10 cursor-help transition-all duration-200 hover:border-basement-cyan/50">
                ...
                <p className="text-xl font-bold text-basement-cyan">
                  {totalAssets ? formatUnits(totalAssets, 18) : '0'} stCORE
                </p>
              </div>
            </Tooltip>
          </div>
          ...
          <div className="relative">
            ...
            {type === 'deposit' && (
              <div className="absolute right-0 -bottom-6 text-xs text-gray-500">
                Available: {usdcBalance ? formatUnits(usdcBalance, 18) : '0'}{' '}
                stCORE
              </div>
            )}
          </div>
          ...
          {showStrategies && (
            <div className="mt-4 space-y-3">
              ...
              <div className="p-3 rounded-lg bg-gradient-to-r from-basement-cyan/5 to-transparent border border-basement-cyan/20">
                <div className="flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-basement-cyan/10 text-lg shrink-0">
                    🤖
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      The AI only optimizes allocation between vetted strategies
                      while maintaining full asset security.
                    </p>
                  </div>
                </div>
              </div>
