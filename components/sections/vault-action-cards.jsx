        ...
        >
          <h1 className="group text-center font-display text-2xl font-light leading-tight lg:text-4xl z-10 mb-8">
            <SectionTitle>
              ...
              <SectionTitleFade>
                <div
                  className="font-basement text-lg p-2 uppercase text-basement-cyan"
                  ref={titleRef}
                >
            ...
            >
              ...
              <div className="relative flex flex-col w-full">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <div className="font-belgro text-white/80 text-sm">
                      Strategy
                    </div>
                    <div className="font-basement text-basement-cyan text-lg">
                      AI stCORE Yield Optimizer
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4 py-3 border-y border-white/10">
                  <div>
                    ...
                    <div className="text-sm font-basement text-white">
                      1,000 stCORE
                    </div>
                  </div>
